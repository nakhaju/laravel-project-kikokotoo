											...
											<div class="widget-box transparent">
												...
												<div class="widget-body">
													<div class="widget-main padding-8">
														<div id="profile-feed-1" class="profile-feed ace-scroll" style="position: relative;"><div class="scroll-track scroll-active" style="display: block; height: 200px;"><div class="scroll-bar" style="height: 63px; top: 24px;"></div></div><div class="scroll-content" style="max-height: 200px;">
																	...
																	<div class="widget-main padding-16">
																		<div class="clearfix">
																			<div class="grid3 center">
																				...
																				<canvas height="79" width="79" style="height: 72px; width: 72px;"></canvas></div>
