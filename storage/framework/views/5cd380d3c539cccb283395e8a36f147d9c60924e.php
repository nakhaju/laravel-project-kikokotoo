				...
				<div class="navbar-header pull-left">
					<a href="<?php echo e(url('/')); ?>" class="navbar-brand">
						<small>
							...
							ZANZIBAR REVOLUTIONARY GORVEMENT 
						</small>
					</a>
				</div>
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo e(url('/form-data')); ?>">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo e(url('view-data')); ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									View Staff
								</a>
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							<i class="menu-icon fa fa-list"></i>
							<span class="menu-text"> FORM ELEMNTS </span>
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo e(url('form-elements')); ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Form Input element
								</a>
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo e(url('table-elements')); ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Table element
								</a>
...
<?php /**PATH C:\Users\nakha\Desktop\kikokotoo\resources\views/layout/app.blade.php ENDPATH**/ ?>