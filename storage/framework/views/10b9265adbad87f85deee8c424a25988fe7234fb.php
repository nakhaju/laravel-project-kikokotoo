						...
						<div class="row">
							...
							<form action="<?php echo e(url('/data-Submit')); ?>" method="POST"> 
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="text" name="fname" id="form-field-1" placeholder="Full Name" class="col-xs-10 col-sm-5" autocomplete="off" />
										</div>       
									</div><br/><br/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="zanid" id="form-field-1" placeholder="Employee no." class="col-xs-10 col-sm-5" autocomplete="off" />
										</div>       
									</div><br/><br/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 3.Possition  </label>
											...
											<div class="input-group">
												<select class="form-control" name="position" id="form-field-select-1">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control date-picker" name="dob" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control date-picker" name="doc" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy">
												<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
					    					</div>
										</div>
									</div><br/><br/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 6.Date of Retire  </label>
				
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control date-picker" name="dor" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy">
												<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
					    					</div>
										</div>
									</div><br/><br/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 7.Cause of Retire  </label>
				
											<div class="col-sm-4">
											<div class="input-group">
												<select class="form-control" name="cause_of_retire" id="form-field-select-1">
													<option value="" selected disabled>Select Cause of Retire</option>
